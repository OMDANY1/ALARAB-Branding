...
export const IconWrapper = ({ children, className = 'w-5 h-5' }) => (
...
export const Volume2 = ({ className }) => (
  <IconWrapper className={className}>
...
export const VolumeX = ({ className }) => (
  <IconWrapper className={className}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
...
export const ShieldAlert = ({ className }) => (
  <IconWrapper className={className}>
    <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" />
    <path d="M12 8v4" />
    <path d="M12 16h.01" />
...
export const LayoutGrid = ({ className }) => (
  <IconWrapper className={className}>
...
export const Monitor = ({ className }) => (
  <IconWrapper className={className}>
...
export const UtensilsCrossed = ({ className }) => (
  <IconWrapper className={className}>
    <path d="m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8a3 3 0 0 0 4.2 0L22 8Z" />
    <path d="M15 15 3.3 3.3a2 2 0 0 0-2.8 2.8L12 17.7" />
    <path d="m2 22 10-10" />
  </IconWrapper>
);
...
export const Smartphone = ({ className }) => (
  <IconWrapper className={className}>
